...
exports.deleteDisk = exports.ensureDisk = exports.trashDisk = exports.batchDisk = exports.frameDisk = exports.copyDisk = exports.load_listDisk = exports.listDisk = exports.readDisk = exports.writeDisk = exports.updateDisk = exports.initDisk = void 0;
...
const listDisk = async (cpy, bal, ste) => {
    ...
    if (bal.slv != null)
        bal.slv({ dskBit: { idx: "list-disk", src: bal.src, lst } });
    return cpy;
};
exports.listDisk = listDisk;
const load_listDisk = async (cpy, bal, ste) => {
    bit = await ste.hunt(ActDsk.LIST_DISK, { src: bal.src });
    lst = bit.dskBit.lst;
    lst.forEach((a, b) => {
        lst[b] = bal.src + a;
    });
